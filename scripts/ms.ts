...
const SQUARE_WIDTH_PX: number = 36; // 30 for square plus 6 for border on either side
...
class MinesweeperSquare extends Square {
	isMine: boolean;
	isFlagged: boolean;
...
class Minesweeper {
	...
	populate() {
		...
		let nPix = this.width * SQUARE_WIDTH_PX;
